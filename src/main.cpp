...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 420000); // Null: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Null: 3.5 days
static const int64 nTargetSpacing = 45; // Null: 2.5 minutes
...
{
    // Null: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
